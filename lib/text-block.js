...
module.exports = exports = class WinUITextBlock extends FrameworkElement {
  ...
  get maxLines() {
    return binding.textBlockMaxLines(this._tag)
  }

  set maxLines(value) {
    binding.textBlockMaxLines(this._tag, value)
  }

  get textTrimming() {
    return binding.textBlockTextTrimming(this._tag)
  }

  set textTrimming(value) {
    binding.textBlockTextTrimming(this._tag, value)
  }
}

exports.TEXT_TRIMMING = {
  NONE: binding.TEXT_TRIMMING_NONE,
  CLIP: binding.TEXT_TRIMMING_CLIP,
  WORD_ELLIPSIS: binding.TEXT_TRIMMING_WORD_ELLIPSIS,
  CHARACTER_ELLIPSIS: binding.TEXT_TRIMMING_CHARACTER_ELLIPSIS
}
