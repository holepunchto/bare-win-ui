...
module.exports = exports = class WinUIRun extends DependencyObject {
  ...
  set textDecorations(value) {
    binding.runTextDecorations(this._tag, value)
  }

  get characterSpacing() {
    return binding.runCharacterSpacing(this._tag)
  }

  set characterSpacing(value) {
    binding.runCharacterSpacing(this._tag, value)
  }
...
exports.TEXT_DECORATIONS = {
  NONE: binding.TEXT_DECORATIONS_NONE,
  UNDERLINE: binding.TEXT_DECORATIONS_UNDERLINE,
  STRIKETHROUGH: binding.TEXT_DECORATIONS_STRIKETHROUGH
}
