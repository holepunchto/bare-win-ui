...
const CompositionPathGeometry = require('./composition-path-geometry')
...
module.exports = exports = class WinUICompositor extends WinUIObject {
  ...
  createPathGeometry(path) {
    if (path === undefined) {
      return wrap(CompositionPathGeometry, binding.compositorCreatePathGeometry(this._tag))
    }

    return wrap(
      CompositionPathGeometry,
      binding.compositorCreatePathGeometry(this._tag, adopt(path))
    )
  }
