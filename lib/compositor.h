...
static js_value_t *
bare_win_ui_compositor_create_sprite_visual(js_env_t *env, js_callback_info_t *info) {
  int err;
  ...
  try {
    result = bare_win_ui__from_object(env, compositor.CreateSpriteVisual());
  } catch (hresult_error const &error) {
    bare_win_ui__throw(env, error);
...
static js_value_t *
bare_win_ui_compositor_create_drop_shadow(js_env_t *env, js_callback_info_t *info) {
  int err;
  ...
  try {
    result = bare_win_ui__from_object(env, compositor.CreateDropShadow());
  } catch (hresult_error const &error) {
    bare_win_ui__throw(env, error);
...
static js_value_t *
bare_win_ui_compositor_create_visual_surface(js_env_t *env, js_callback_info_t *info) {
  int err;
  ...
  try {
    result = bare_win_ui__from_object(env, compositor.CreateVisualSurface());
  } catch (hresult_error const &error) {
    bare_win_ui__throw(env, error);
...
static js_value_t *
bare_win_ui_compositor_create_surface_brush(js_env_t *env, js_callback_info_t *info) {
  int err;
  ...
  try {
    if (argc == 1) {
      result = bare_win_ui__from_object(env, compositor.CreateSurfaceBrush());
    } else {
      ICompositionSurface surface = nullptr;
      if (!bare_win_ui__read_nullable(env, argv[1], "surface", &surface)) return nullptr;

      result = bare_win_ui__from_object(env, compositor.CreateSurfaceBrush(surface));
    }
  } catch (hresult_error const &error) {
    bare_win_ui__throw(env, error);
...
static js_value_t *
bare_win_ui_compositor_create_path_geometry(js_env_t *env, js_callback_info_t *info) {
  int err;
  ...
  try {
    if (argc == 1) {
      result = bare_win_ui__from_object(env, compositor.CreatePathGeometry());
    } else {
      CompositionPath path = nullptr;
      if (!bare_win_ui__read_nullable(env, argv[1], "path", &path)) return nullptr;

      result = bare_win_ui__from_object(env, compositor.CreatePathGeometry(path));
    }
  } catch (hresult_error const &error) {
    bare_win_ui__throw(env, error);
