...
prebuilds['win32-x64'] = () => {
  return {
    ...
    dependencies: [
      require.asset('./prebuilds/win32-x64/bare/Microsoft.Graphics.Canvas.dll', __filename),
...
prebuilds['win32-arm64'] = () => {
  return {
    ...
    dependencies: [
      require.asset('./prebuilds/win32-arm64/bare/Microsoft.Graphics.Canvas.dll', __filename),
